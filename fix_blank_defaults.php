...
$username = 'dba';  // same as DB_SERVER_USERNAME in configure.php
$password = 'huntley';  // same as DB_SERVER_PASSWORD in configure.php
$db = 'voila';  // same as DB_DATABASE in configure.php
...
foreach ($tables as $table) {
    ...
    foreach ($table as $key => $fieldlist) {
       ...
       foreach ($fields as $field) {
          ...
          printMySqlErrors();
          echo "ALTER TABLE `{$fulltablename}` ALTER `{$field}` SET DEFAULT ''" . '<br>'; 
       }
    }
